...
func NewCreateProductCommand(productID uuid.UUID, name, description string, price float64) *CreateProductCommand {
...
func NewUpdateProductCommand(productID uuid.UUID, name, description string, price float64) *UpdateProductCommand {
